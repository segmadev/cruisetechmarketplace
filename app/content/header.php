...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-theme="blue_theme" data-layout="vertical" data-sidebartype="full"
        data-sidebar-position="" data-header-position="">
        <!-- Sidebar Start -->
           ...
           -->
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="index?p=rentals&action=new" aria-expanded="false">
                                ...
                                <span class="hide-menu">Get Number</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
              ...
              <a class="sidebar-link" href="index?p=orders" aria-expanded="false">
                ...
                <span class="hide-menu">Orders</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" data-url="index?p=deposit&action=transactions"
                                aria-expanded="false">
                                <span>
                ...
                <span class="hide-menu">All Activities</span>
                            ...
                            <a href='index?p=profile' class="hstack gap-3">
                                ...
                                <div class="john-title">
                                    <h6 class="mb-0 fs-3 fw-semibold">
                                        <?= $d->short_text($u->get_name($userID), 8, true) ?></h6>

                                </div>
                                <button class="border-0 p-2 rounded-1 text-danger bg-light-danger ms-auto" tabindex="0"
                                    type="submit" aria-label="logout" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <ul id="sidebarnav">
                        <li class="sidebar-item bg-light-primary mt-2">
                            <a class="sidebar-link" target="_BLANK" href="<?= $d->get_settings("telegram") ?>"
                                aria-expanded="false">
                                <span>
                                    <img src="https://cdn.pixabay.com/photo/2021/12/27/10/50/telegram-icon-6896828_960_720.png"
                                        style="width:20px" srcset="Join out telegram channel">
                                </span>
                                <span class="hide-menu"> <span class="m-0 p-0">Join Our Telegram</span>
                                    <p class="fs-2 text-muted m-0 p-0">for news and update</p>
                                </span>
                    ...
                    <ul id="sidebarnav bg-transparent border-1 border-danger">
                        <li class="sidebar-item  mt-2">
                            <a class="sidebar-link" href="index?p=viewer&action=new" aria-expanded="false">
                                ...
                                <span class="hide-menu"> <span class="m-0 p-0 text-danger">Get Help</span>
                                    <p class="fs-2 text-muted m-0 p-0">How to use our platfrom</p>
                                </span>
