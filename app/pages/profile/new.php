...
<div class="container mt-5">
    ...
    <p>
        Our discount plan is to reward users for being loyal and actively funding their accounts. The more Deposit you
        accumulate, the higher your level and the better your discount on future orders. Each level comes with:
    </p>
    <ul>
        ...
        <li><b>Minimum Order:</b> The minimum number of accounts you need to order in one transaction to enjoy the
            discount.</li>
    </ul>
    <p class='p-2 bg-light-danger  text-black'>
        <b>Note:</b>
