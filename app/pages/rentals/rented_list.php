<?php 
    if($no_rented < 1) {
      ...
      $script[] = "countdown";
        ...
        $rented_numbers_non_active = $d->getall("orders", "userID = ? and accountID != ? and order_type = ? and (status = ? or status = ?) ORDER BY date desc LIMIT 20", [$userID, "", "rentals", 0, 2], fetch: "all");
?>
