                ...
                <div class="d-flex p-2 flex gap-2">
                    ...
                    <div class="btn-group mb-2 print-ignore">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                ...
                                <li><a class="dropdown-item" href="index?p=rentals&network=6&action=new&countryCode=16&symbol=GB&name=United%20Kingdom&networkName=All Countries (Short Term 2)">All Countries (Short Term)</a></li>
                                <li><a class="dropdown-item" href="index?p=rentals&network=5&action=new&countryCode=16&symbol=GB&name=England&networkName=All Countries (Short Term)">All Countries (Short Term 2)</a></li>
                            </ul>
                        </div>
